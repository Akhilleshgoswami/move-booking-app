...
const router = (app) => {
 ...
 app.delete("/mba/api/v1/theater/:id", isAuthenticated,TheaterController.deleteTheater)
 ...
 app.get("/mba/api/v1/theater/:theaterId/movies/:movieId", TheaterController.checkMovie)
}
